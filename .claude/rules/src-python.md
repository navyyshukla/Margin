...
**46 of them are in these files** — 10 in `cli_test.py` alone — out of 76 across
the repo (re-measured 2026-09-11; this said 20 and 27, wrong in both halves), so
**do not renumber them**; new rules append.
